...
export ZHEN_DIR='/data00/wuwei.ai/data/translation/shenjian_en_zh_tfmr' # Download instructions above
...
python finetune.py \
    --num_train_epochs 6 --src_lang en_XX --tgt_lang zh_CN\
    --learning_rate=3e-5 \
    --fp16 \
    --do_train \
    ...
    --output_dir enzh_finetune_fresh_start \
    --label_smoothing 0.1 \
    --fp16_opt_level=O1 \
    --logger_name wandb \
    --eval_beams=1 \
